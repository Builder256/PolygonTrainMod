...
public class PolygonTrainMod {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MAIN_TAB =
        CREATIVE_MODE_TABS.register("main_tab", () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                ...
                output.accept(PolygonTrainModItems.WRENCH_ITEM.get());
                output.accept(PolygonTrainModItems.TEST_AUTOMATIC_TICKET_GATE_ITEM.get());
                output.accept(PolygonTrainModItems.CROSSING_GATE_ITEM.get());
                ...
                output.accept(PolygonTrainModItems.LIGHT_ITEM.get());
                output.accept(PolygonTrainModItems.SIGNBOARD_ITEM.get());
                output.accept(PolygonTrainModItems.INSULATOR_ITEM.get());
                output.accept(PolygonTrainModItems.WIRE_ITEM.get());
                output.accept(PolygonTrainModItems.SIGNAL_ITEM.get());
            }).build());
    ...
    private void commonSetup(FMLCommonSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            com.portofino.polygontrainmod.installedobject.InstalledObjectPackLoader.load();
    ...
    private void buildCreativeTabContents(BuildCreativeModeTabContentsEvent event) {
        if (CreativeModeTabs.REDSTONE_BLOCKS.equals(event.getTabKey())) {
            event.accept(PolygonTrainModItems.CROSSING_GATE_ITEM.get());
            event.accept(PolygonTrainModItems.SIGNAL_ITEM.get());
        }
    }
}
