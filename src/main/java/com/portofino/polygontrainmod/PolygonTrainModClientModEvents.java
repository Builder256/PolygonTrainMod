...
import com.portofino.polygontrainmod.client.renderer.CarRenderer;
import com.portofino.polygontrainmod.client.renderer.InstalledObjectBlockEntityRenderer;
...
public final class PolygonTrainModClientModEvents {
    ...
    public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerBlockEntityRenderer(
            PolygonTrainModBlockEntities.INSTALLED_OBJECT.get(),
        ...
        event.registerEntityRenderer(
            com.portofino.polygontrainmod.registry.PolygonTrainModEntities.CAR.get(),
            CarRenderer::new
        );
    }

    /** legacy と同じく tintindex=0 で色を差し替える。通常マーカー=赤、分岐マーカー=青。 */
    @SubscribeEvent
