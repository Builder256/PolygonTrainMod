...
public class VehicleModelPackManager implements ResourceManagerReloadListener {
    ...
    public void initialize(ResourceManager resourceManager) {
        ...
        PolygonTrainMod.LOGGER.info("Initializing legacy Model Pack Manager...");
        ...
        try {
            ...
            initialized = true;
            PolygonTrainMod.LOGGER.info("legacy Model Pack Manager initialized successfully");
            
        } catch (Exception e) {
            PolygonTrainMod.LOGGER.error("Failed to initialize legacy Model Pack Manager", e);
        }
    }
    ...
    private List<VehicleConfig> parseVehicleConfigs(com.google.gson.JsonArray vehiclesArray) {
        ...
        for (JsonElement element : vehiclesArray) {
            ...
            // Parse legacy-style seat positions
    ...
    private List<net.minecraft.world.phys.Vec3> parselegacySeatPositions(JsonObject obj) {
        ...
        // legacy style: seatPos is often 1/16 units, seatPosF/playerPos/playerPosF are block units.
    ...
    public static class ModelPack {
        ...
        public void registerVehicles() {
            for (VehicleConfig vehicle : config.vehicles) {
                try {
                    // Convert legacy VehicleConfig to PolygonTrainMod VehicleDefinition
        ...
        private VehicleDefinition convertToVehicleDefinition(VehicleConfig vehicle) {
            // Convert legacy config to PolygonTrainMod format
            ...
            return new VehicleDefinition(
                ...
                java.util.List.of(), // playerPositions (VehicleModelPackManager では未対応)
