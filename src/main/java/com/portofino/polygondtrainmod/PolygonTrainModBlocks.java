...
public class PolygonTrainModBlocks {
    ...
    // テスト改札機を登録
    public static final DeferredBlock<GateBlock> TEST_AUTOMATIC_TICKET_GATE = BLOCKS.register("test_automatic_ticket_gate", ()-> new GateBlock(BlockBehaviour.Properties.of().sound(SoundType.STONE).noOcclusion()));
}
